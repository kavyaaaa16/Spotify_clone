    ...
    <div className='bg-[#121212] h-[85%] rounded'>
        ...
        
        {
            user && user.role == "admin" && (
                <button className='px-4 py-1.5 bg-white text-black text-[15px] rounded-full mt-4' onClick={()=>navigate("/admin")}>Admin Dashboard</button>
            )
        }
    </div>
    </div>
